...
class Methods:
    def __init__(self):
        ...
        self.methods = {
            "euler": {"name": "Euler Simples", "function": self.euler},
            "euler_inverso": {"name": "Euler Inverso", "function": self.inverse_euler},
            "euler_aprimorado": {
                "name": "Euler Composto",
                "function": self.composite_euler,
            },
            "runge_kutta": {"name": "Runge-Kutta", "function": self.runge_kutta},
            "adam_bashforth": {
                "name": "Adams-Bashforth",
                "function": self.adams_bashforth,
            },
            "adam_multon": {"name": "Adams-Moulton", "function": self.adams_moulton},
    ...
    def adams_moulton_implicit(self, order, ts, ys, index, f_expr, h):
        ...
        f_side = (
            self.adams_moulton_coeficients[order][i] * f_i * h
